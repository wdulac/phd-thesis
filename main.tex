...
Si le travail de thèse est \textit{in fine} un travail individuel, il est évident qu'il ne peut avoir lieu, et encore moins aboutir, sans le concours actif d'un
plus grand nombre de personnes. En particulier, l'encadrement joue sans conteste le rôle le plus déterminant dans le déroulement d'une thèse, et c'est donc
naturellement à mes deux encadrants, Julien et Fabrice, que j'adresse mes remerciements en premier. Merci d'abord à Julien pour ces trois années, depuis
l'élaboration du sujet de thèse et la préparation du concours de l'école doctorale jusqu'à la fermeture du bar, le soir après ma soutenance. Ta qualité que j'ai
préférée pendant la thèse fut sans doute la sérénité avec laquelle tu abordais toutes les situations, qui pour moi se présentaient comme des problèmes soit très
ennuyeux sinon potentiellement catastrophiques, et de toujours y proposer des solutions, m'offrant ainsi le sentiment soulageant que tout était largement sous
contrôle. Merci également à Fabrice de m'avoir fait bénéficier d'une part de ta grande expertise sur les cyclones tropicaux ainsi que sur le traqueur, et
d'autre part de ta bonne humeur et de ton humour quasi constant. Au delà de la thèse, tu m'as également accueilli en stage de fin d'études en 2019, à la suite
de quoi c'est aussi en grande partie grâce à toi que j'ai pu être embauché au CNRM avant de démarrer la thèse, et tu m'as également présenté Julien pour
commencer à discuter du projet de thèse. Pour tout ça je te suis très reconnaissant. En tant qu'encadrants de thèse, vous formiez un binôme très complémentaire,
et je vous dis donc merci encore à tous les deux pour votre rôle essentiel à l'aboutissement de ma thèse.
