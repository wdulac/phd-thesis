...
\newenvironment{acknowledgements}%
    ...
    {\vfill\null}
        \begin{acknowledgements}
            ...
            équipe~--- m'a encouragé à mener cette thèse, ce qui impliquait pour moi de démissionner de mon poste actuel et donc pour lui de perdre la personne
            s'occupant entre autres du contrôle qualité des simulations climatiques régionales.
