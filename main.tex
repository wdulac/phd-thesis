...
Le travail de thèse possède une particularité quelque peu paradoxale. S'il s'agit \textit{in fine} d'un travail individuel, il ne peut avoir lieu --- et encore
moins aboutir --- sans le concours actif d'un plus grand nombre de personnes. En particulier, l'encadrement joue sans conteste le rôle le plus déterminant dans
le déroulement d'une thèse.
