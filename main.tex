...
\usepackage[backend=biber, style=authoryear-comp, autocite=inline, maxbibnames=20, minbibnames=20, maxcitenames=2, backref=true, backrefstyle=three, date=year, isbn=false, giveninits=true, uniquelist=false, uniquename=init, natbib=false]{biblatex} %uniquename=full
...
\usepackage[a4paper, top=2.5cm, bottom=2cm, margin=2cm, bindingoffset=6mm]{geometry}
