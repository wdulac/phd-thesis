...
\usepackage[backend=biber, style=authoryear, autocite=inline, maxbibnames=20, minbibnames=20, backref=true, backrefstyle=three, date=year, isbn=false, giveninits=true, uniquelist=false, natbib=false]{biblatex} %uniquename=full
