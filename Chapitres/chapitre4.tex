...
\subsection{Application en climat plus chaud}
...
\subsubsection{Description des simulations}
...
\subsubsection{Détection des cyclogénèses}
...
\subsubsection{Indices de cyclogénèse}
...
Nous comparons également le changement future/présent par l'intermédiaire de l'indice LM10, dont les coefficients $b$ furent obtenus entre ERA5 et IBTrACS.
Notons que la régression LM10 est recalculée pour obtenir des coefficients à l'échelle du bassin SInd, plutôt que pour SIndW et SIndE séparément. Les
coefficients en résultant valent approximativement la moyenne entre les coefficients LM10 sur les deux sous-régions du bassin SInd (voir
\cref{tab:tab:coefs_fit_bassin} du \cref{chap:chapitre_3}, \vpageref{tab:coefs_fit_bassin}). Enfin, le TCS est également utilisé à titre de référence. Le
\cref{tab:coeffs_experiences} présente (ou rappelle) les coefficients des indices sus-mentionnés.
...
\begin{table}[htpb]
    ...
    \begin{tabular}{llrrrrrrr}
        \toprule\toprule
        \multicolumn{2}{c}{\textbf{Indice}} & \multicolumn{6}{c}{\textbf{Coefficients}} & \multicolumn{1}{c}{\textbf{Calibration}} \\
        \midrule
