...
\begin{figure}[htb]
    ...
    schéma de détection, entre 1980 et 2011.}
...
il ne fait toutefois aucun doute que le niveau d'activité des indices dépasse celui d'un simple bruit de fond.}. Or, un tel biais est présent dans le GPI et le
TCS (de même que tous les indices dérivés du TCS définis dans ce manuscrit jusqu'à maintenant, et notamment AM10), lequel est brièvement mentionné dans le
\cref{chap:chapitre_3} (\cref{sec:proprietes_indices}).
...
\num{0.17} TC par an) à \num{0.03} TC par an. Cette région ne présente pas d'activité cyclonique dans les observations, ni dans les données du traqueur, mais
