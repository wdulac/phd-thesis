...
de telle sorte à augmenter significativement sa résolution sur une région d'intérêt \parencite{courtier_global_1988}. Pour ce faire, le pôle de la grille est
...
d'identifier les HTV dans les simulations et d'analyser directement leurs caractéristiques, tels qu'ils sont représentés dans les modèles globaux. Cette façon
...
le modèle CNRM-CM6-1-HR présente un rapport légèrement supérieur à \num{2} entre les fréquences annuelles de l'hémisphère nord et sud avec TempestExtreme ---~un
ratio très proche de celui observé~--- la différence s'amoindrit lorsque ce dernier est remplacé par TRACK. Dans d'autres cas, comme pour le modèle ECMWF-LR,
...
scientifique peut ensuite exploiter afin d'étudier divers aspects du forçage anthropique sur le système climatique. Ainsi, les projections futures des diverses
...
à la résolution des modèles utilisées, puisque \cite{knutson_tropical_2020} soulignent que les modèles de résolution relativement basses (par rapport aux études
