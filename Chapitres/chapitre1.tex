...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.7\textwidth]{camargo_2013_NTC_per_year.jpg}
    \caption{Distributions du nombre de TC annuel à l'échelle globale dans les observations sur la période \num{1980}~--~\num{2005} (gauche) ainsi que dans des
    simulations historiques de la période \num{1950}~--~\num{2005} issues de \num{14} modèles couplés de CMIP5, avec des résolutions variant de \km{300} à
    \km{110}. Tous les modèles présentés ici sous-estiment la fréquence de HTV, et le modèle ici dénommé M13 est celui doté de la résolution la plus fine. Figure
    issue de \cite{camargo_global_2013}.}
    \label{fig:NTC_CMIP5}
\end{figure}

Les modèles se sont ensuite améliorés, et s'ils souffrent toujours de la sous-estimation de l'intensité maximale, ils sont désormais capables de simuler
...
comme en atteste la \cref{fig:NTC_CMIP5}. Sans être le seul facteur, les modèles à plus haute résolution simulent généralement plus de HTV que ceux de
résolution inférieure \parencite{camargo_global_2013,roberts_impact_2020}.
