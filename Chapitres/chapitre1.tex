...
\subsubsection{Approche directe et indirecte pour l'étude de l'activité cyclonique}\label{sec:tracking_vs_indices}
...
les points entre eux de façon à former des trajectoires. Ces données permettent ensuite d'analyser le cycle de vie des systèmes et de calculer des statistiques
...
%Par exemple,
%\cite{manabe_tropical_1970} produisit les trajectoires présentés sur la \cref{fig:tracks_manabe} en identifiant les minimums de pression correspondant à une
%dépression d'au moins \hPa{2} et cessa le suivi lorsque ces systèmes atteignirent les moyennes latitudes\footnote{L'histoire ne dit pas si Manabe utilisa un
%schéma de détection automatique et il semble plausible que le travail fut réalisé manuellement. Cet exemple illustre néanmoins le caractère subjectif de la
%détection de HTV.}
