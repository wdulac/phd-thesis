...
au mieux les informations. Pour cette raison, IBTrACS est la base de données observationnelle qui est utilisée à travers tout ce document.

Il demeure que toutes les sources d'hétérogénéité mentionnées, spatiales comme temporelles, y compris la rupture causée par l'avènement de l'ère satellitaire,
constituent autant de limites à l'analyse de tendances historiques de l'activité cyclonique tropicale.

\begin{figure}[tbp]
    \centering
    \includegraphics[width=\textwidth]{trends_lmi_kossin_2013.jpg}
\caption{Test, \cite{kossin_trend_2013}}
    \label{fig:observed_trends}
\end{figure}

% Il en découle que l'étude de l'impact du réchauffement climatique sur l'activité cyclonique nécessite d'autant plus le recours à des modèles de climat.
