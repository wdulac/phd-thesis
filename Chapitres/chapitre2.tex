...
\begin{figure}[htpb]
    ...
    \caption{Gradient méridional de la hauteur géopotentielle à \hPa{200} pour 6 échéances tirées aléatoirement dans la saison 2019 de l'hémisphère sud dans la
    réanalyse ERA5. Le tracé noir relie les points du gradient maximal pour chaque longitude.}
...
linéairement entre les deux points les plus proches dans l'éventualité où le STJ ne soit pas défini sur une tranche de longitude donnée. Le lissage temporel sur
30 jours glissants est utile pour avoir un STJ bien défini, mais tout type de lissage temporel rend une implémentation online impossible, si bien que ce type de
filtre ne peut que s'appliquer comme un post-traitement.
