...
temporellement en dernier recours si aucun point ne remplit les critères à un pas de temps donné. Le lissage temporel sur 30 jours glissants est utile pour
avoir un STJ bien défini, mais tout type de lissage temporel rend une implémentation online impossible, si bien que ce type de filtre ne peut que s'appliquer
comme un post-traitement.
...
prendre la limite équatorielle plutôt que le maximum du champ, tandis que le lissage sur 30 jours glissants permet d'atteindre une meilleure homogénéité en
...
équatoriale subit des sauts soudains de plus de \ang{20}, comparables dans leur amplitude aux sauts réalisés par le filtre du gradient de géopotentiel. Le
second cas (2\ieme~ligne) présente un jet subtropical presque absent, avec deux parcelles principales dont le vent ne dépasse pas \ms{40}, l'un autour de
\ang{60}E et l'autre centré sur \ang{60}W. Notons que dans ces cas où le jet n'est pas défini sur les extrémités latérales du domaine, l'interpolation linéaire
se fait temporellement. Les cas où le courant jet est faible et seulement partiellement défini sont nombreux durant la saison estivale, tout du moins durant
l'année 2017. Dans ces cas là, le caractère lisse de la limite équatoriale du STJ est très largement le résultat de l'interpolation. Le troisième cas
(3\ieme~ligne) présente une situation où du vent fort est identifié au niveau de l'équateur, causant une chute de la latitude issue du diagnostique à \ang{0}N.
