...
Les courants jet stratosphériques, causés par le gradient de température entre les pôles et l'équateur, apportent du cisaillement qui affaiblit les cyclones
...
$V_U^T$), soit un taux de faux positifs a presque doublé. C'est toutefois dans le SPac que le filtre considéré dans cette section est le moins efficace, avec un
...
préféré dans \textcite{dulac_assessing_2023} pour l'implémentation dans le traqueur du CNRM. Outre le fait qu'il ne dépend que des champs instantanés de l'atmosphère, il
...
Réciproquement, l'union $C \cup Q$ contient l'entièreté des échéances constituant le couple de trajectoires. Enfin, la différence symétrique des deux
