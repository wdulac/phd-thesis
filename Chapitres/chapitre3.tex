...
\subsection{Incertitudes et limitations}

En accord avec la grande diversité des formulations et choix de prédicteurs définissant les divers indices de cyclogénèses présentés dans la
\cref{sec:tour_horizon_indices}, leurs propriétés sont également variables. La \cref{fig:tcs_cygp_gpi_zonal} présente la distribution méridionale de l'activité
pour les trois indices explicités dans la \cref{sec:tour_horizon_indices} et évalués sur les moyennes mensuelles ERA5 entre \num{1981} et \num{2019}, comparée à
celle d'IBTrACS sur la même période. Ici, les indices sont calibrés de la même manière que dans \textcite{menkes_comparison_2012} ---~qui comparent ces trois
indices (ainsi que le YGP) sur quatre réanalyses atmosphériques antérieures à ERA5~--- à savoir en les normalisant de telle sorte à ce que le nombre de TC moyen
par an simulé soit égal à la moyenne anuelle de systèmes observés dans IBTrACS entre \ang{30}S et \ang{30}N sur la période considérée, soit 83. Comme indiqué
par \textcite{menkes_comparison_2012}, les trois indices tendent à sur-évaluer l'activité cyclonique à proximité de l'équateur.

\begin{figure}[htb]
    \centering
    \includegraphics[width=0.8\textwidth]{tcs_cygp_gpi_ibt_zonal_sum_1981_2019.png}
    \caption{Somme zonale de la moyenne annuelle du TCS, CYGP et du GPI calculés sur les champs mensuels ERA5 interpolés sur une grille
    régulière de 1° de résolution horizonale, entre 1981 et 2019. Le tracé en tirets indique la somme zonale du décompte annuel moyen des premières observations
    des systèmes IBTrACS renseignés comme tempêtes tropicales ou subtropicales sur la même période et sur la même grille régulière.}
