...
à la matrice $\mathbf{x}$ de taille $(m \times n^\prime)$, où $n^\prime = n + 1$, composée de $n$ prédicteurs ainsi que d'une constante unitaire, chacun
avec $m$ observations, par le vecteur colonne $\mathbf{b}^{\mathrm{T}}$ des coefficients $b$, de taille $n^\prime$, de la façon suivante :
%
\begin{align*}
