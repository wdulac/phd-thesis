...
de d'espérer pouvoir l'améliorer sans introduire de variabilité temporelle dans la régression. Quant à la résolution, nous utilisons les champs à \ang{1} de
...
\begin{table}[htpb]
    ...
    \begin{tabular}{lrrrrrrrr}
       \toprule\toprule 
       \multicolumn{1}{c}{Bassin} & \multicolumn{5}{c}{Coefficients} & \multicolumn{3}{c}{Détails}\\
       \midrule
               & $b_0$ & $b_{\eta}$ & $b_{V_{\mathrm{shear}}}$ & $b_H$ & $b_T$ & $N_{\mathrm{lon}}$     & $N_{\mathrm{lat}}$ & $m_{\mathrm{eff}}$ \\
       \midrule
       NAtl    & \num{-17.3713} & \num{2.1677} & \num{-0.0594} & \num{0.0651}  & \num{0.3313} & \num{96}  & \num{60}  & \num{1510560} \\
       WPac    & \num{-14.2693} & \num{0.9547} & \num{-0.0715} & \num{0.0760}  & \num{0.4860} & \num{77}  & \num{60}  & \num{1244640} \\ 
       EPac    & \num{-16.2217} & \num{1.5829} & \num{-0.0805} & \num{0.0748}  & \num{0.6970} & \num{102} & \num{60}  & \num{1862400} \\
