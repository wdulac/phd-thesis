...
indices sont donc encore pertinents pour beaucoup de modèles CMIP6, dont la résolution spatiale atteint jusqu'à \km{250}. Par ailleurs, l'application d'un indice de
cyclogénèse à une simulation est nettement plus aisée que le déploiement d'un schéma de détection et suivi objectif, lequel apporte nécessairement de la
complexisté additionnelle, et nécessite de traiter les sorties des modèles à une fréquence sub-journalière.
